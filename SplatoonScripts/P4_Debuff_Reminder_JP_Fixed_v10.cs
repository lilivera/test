...
{
    public class P4_Debuff_Reminder_JP_Fixed_v10 : SplatoonScript
    {
        public override Metadata Metadata { get; } = new Metadata(10, "NightmareXIV / JP fixed / large white text");
