...
{
    public class P4_Debuff_Reminder_JP_Fixed_v14_SimpleVoiceroidQueue : SplatoonScript
    {
        public override Metadata Metadata { get; } = new Metadata(14, "NightmareXIV / JP fixed / large white text / SimpleVoiceroid2Proxy queued");
        ...
        private const int VoiceProxyPostGapMs = 250;
            ...
            try
            {
                while (true)
                {
                    ...
                    lock (_voiceQueueLock)
                    {
                        ...
                        text = _voiceQueue.Dequeue();
                    }

                    PostTalk(text);
                    Thread.Sleep(VoiceProxyPostGapMs);
                }
            }
            catch
            {
