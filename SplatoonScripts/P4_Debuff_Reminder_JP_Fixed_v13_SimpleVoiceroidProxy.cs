...
{
    public class P4_Debuff_Reminder_JP_Fixed_v13_SimpleVoiceroidProxy : SplatoonScript
    {
        public override Metadata Metadata { get; } = new Metadata(13, "NightmareXIV / JP fixed / large white text / SimpleVoiceroid2Proxy");
        ...
        private const int VoiceProxyTimeoutMs = 500;
        ...
        private void Speak(string text)
        {
            ...
            {
                var textToSend = text;
                ThreadPool.QueueUserWorkItem(_ => PostTalk(textToSend));
            }
            catch
            {
        ...
        public override void OnSettingsDraw()
        {
            ...
            if (ImGui.Button("VOICEROIDテスト 複数"))
            {
                Speak("見ない、散開、止まる");
            }
